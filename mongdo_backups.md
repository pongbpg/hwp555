...
mongodump --uri="mongodb://root:password@192.168.1.155:27018/" --gzip --archive="db-latest.gz"
mongorestore --uri="mongodb://localhost:27017/hwp555" --gzip --archive="db-2026-03-26_2010.gz" --drop
mongorestore --uri="mongodb://mongo:KTlBvUhGjEidMDEKLAzevAVCOATaiNsU@gondola.proxy.rlwy.net:33948/" --gzip --archive="db-2026-03-26_2010z.gz" --nsExclude="admin.*" --drop